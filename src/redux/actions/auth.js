import {
  LOGIN_FAIL, LOGIN_SUCCESS,LOGIN_START,
  SENDING_EMAIL_ERROR,
...
const fetchData = async (url, method, body, successAction, failAction, notFoundAction, startAction, errorAction, dispatch) => {
...
export const passwordReset = (email) => {
  return async(dispatch) => {
    ...
    await fetchData(url, method, body, successAction, failAction, notFoundAction, startAction, errorAction, dispatch);
  };
};
