import {
  ...
  export const viewWishlist = () => {
    ...
    return async (dispatch) => {
      ...
      const apiUrl = 'https://e-comm-team-amigos-bn-project.onrender.com/wishlist/all'; 
    fetch(apiUrl, {
      headers: {
  ...
  export const removeFromWishlist = (id) => {
    ...
    return async (dispatch) => {
      ...
      try {
        const response = await fetch(`https://e-comm-team-amigos-bn-project.onrender.com/wishlist/remove/${id}`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${authToken}`,
